...
Variable *bTemp = new BoschBME280_Temp(&bme280, "3ab0c7a0-51e9-44aa-b8a0-edfe3dd84e97");
Variable *bHumid = new BoschBME280_Humidity(&bme280, "abad1396-7f9b-4794-a849-16bbbc6487a0");
Variable *bPress = new BoschBME280_Pressure(&bme280, "3d0011ca-59ff-4c34-adc3-48488324fa10");
Variable *bAlt = new BoschBME280_Altitude(&bme280, "f9ba9902-f17a-43bd-a5e1-1b30d138d465");
...
Variable *msTemp = new MeaSpecMS5803_Temp(&ms5803, "0132594a-e3c2-4f2d-8966-c6e623d945d3");
Variable *msPress = new MeaSpecMS5803_Pressure(&ms5803, "0ba0fd67-4835-40be-8224-5b55ad75f251");
...
Variable *variableList[] = {
    ...
    msTemp,
    msPress,
    new MaximDS18_Temp(&ds18_u, "cb626478-3fd9-4959-84aa-3dfadde1036d"),
    new ProcessorStats_FreeRam(&mayfly, "e2887ebb-fd38-4a92-a317-9c642d7ce65c"),
    new ProcessorStats_Batt(&mayfly, "74e2d7d7-7397-4d5f-b6b4-052dd680c398"),
    new MaximDS3231_Temp(&ds3231, "c333f174-540a-414f-8e95-6335f6c22657"),
...
// ==========================================================================
const char *registrationToken = "FIXd0a4d-411b-49cb-ba24-02aa35b8f058";   // Device registration token
const char *samplingFeature = "48818396-629c-401a-bc07-84aeba3a4602";     // Sampling feature UUID


// ==========================================================================
// Extra information and tokens for calculted variables
// ==========================================================================
const char *waterPressureUUID = "0eae3659-c39f-4887-83ff-afe8679b1e74";
...
const char *waterDepthUUID = "0eae3659-c39f-4887-83ff-afe8679b1e74";
const char *waterDepthVarName = "waterDepth";
const char *waterDepthVarUnit = "millimeter";
const char *waterDepthVarCode = "CalcDepth";
const char *rhoDepthUUID = "9d2148af-319d-4061-beb1-63f46cfa83f0";
