...
const char *sketchName = "bixby4.ino";

// Logger ID, also becomes the prefix for the name of the data file on SD card
const char *LoggerID = "Bixby4_Mayfly_170075";
...
Variable *bTemp = new BoschBME280_Temp(&bme280, "ad7f83a5-a89f-4a53-9006-c153435cf98e");
Variable *bHumid = new BoschBME280_Humidity(&bme280, "dcb577ec-6a15-422f-ab94-e799462dea8a");
Variable *bPress = new BoschBME280_Pressure(&bme280, "c79d6ea2-a29e-43db-8762-94e5e19fa824");
Variable *bAlt = new BoschBME280_Altitude(&bme280, "516d063b-220a-4135-94cf-c527f4f17831");
...
Variable *msTemp = new MeaSpecMS5803_Temp(&ms5803, "4550978d-476e-4920-a226-a9e679734793");
Variable *msPress = new MeaSpecMS5803_Pressure(&ms5803, "34356496-175c-470e-9449-fb18ca3f451f");
...
Variable *variableList[] = {
    ...
    msTemp,
    msPress,
    new MaximDS18_Temp(&ds18_u, "21fd9f7d-7433-4157-aae8-7fca1e073410"),
    new ProcessorStats_FreeRam(&mayfly, "35249a66-c026-4a17-bcda-7d51e81e212d"),
    new ProcessorStats_Batt(&mayfly, "2704cc85-a5f8-4842-9647-d1fc93702374"),
    new MaximDS3231_Temp(&ds3231, "fce4e6fe-a28f-47e3-8f1c-606b41a59165"),
...
// ==========================================================================
const char *registrationToken = "FIX80434-158a-4e7b-a813-43f70af0f75b";   // Device registration token
const char *samplingFeature = "3354c8d0-d029-4759-8867-9ce01767fb99";     // Sampling feature UUID


// ==========================================================================
// Extra information and tokens for calculted variables
// ==========================================================================
const char *waterPressureUUID = "6fb92630-2dd2-4ffc-8503-9205458d6675";
...
const char *waterDepthUUID = "6622ce2a-31f1-40b5-acb2-0efb81bc1f64";
const char *waterDepthVarName = "waterDepth";
const char *waterDepthVarUnit = "millimeter";
const char *waterDepthVarCode = "CalcDepth";
const char *rhoDepthUUID = "33f3fd10-eb75-4e73-847c-40728c95db72";
