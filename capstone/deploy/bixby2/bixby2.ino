...
const char *sketchName = "bixby2.ino";

// Logger ID, also becomes the prefix for the name of the data file on SD card
const char *LoggerID = "Bixby2_Mayfly_170087";
...
Variable *bTemp = new BoschBME280_Temp(&bme280, "5abdba27-02a1-480a-86a6-a1b6a4358e29");
Variable *bHumid = new BoschBME280_Humidity(&bme280, "67c0888f-216c-46f1-a79e-880dda715b16");
Variable *bPress = new BoschBME280_Pressure(&bme280, "21e12394-33fc-4e84-a25c-8328392ff3c6");
Variable *bAlt = new BoschBME280_Altitude(&bme280, "efc4ff82-57ab-45f8-9cef-74eb62b3c6e8");
...
Variable *msTemp = new MeaSpecMS5803_Temp(&ms5803, "4603aaee-ed2b-492a-a018-7dcf1f067b41");
Variable *msPress = new MeaSpecMS5803_Pressure(&ms5803, "c17497a5-f049-4198-940a-7deb3e83dfea");
...
Variable *variableList[] = {
    ...
    msTemp,
    msPress,
    new MaximDS18_Temp(&ds18_u, "fecead03-3ef8-467e-bc36-e3c23e97f32d"),
    new ProcessorStats_FreeRam(&mayfly, "3863864a-0e26-4b89-9aa7-644da6713a7f"),
    new ProcessorStats_Batt(&mayfly, "efc54025-906e-403e-84b6-fb33e77b17eb"),
    new MaximDS3231_Temp(&ds3231, "7d171e16-a143-4f40-baa4-28b1179a1069"),
...
// ==========================================================================
const char *registrationToken = "FIXa5eea-4fd6-4749-a0a0-1bcd696c5e10";   // Device registration token
const char *samplingFeature = "5706d885-5c9f-403c-8b69-08385b764ecb";     // Sampling feature UUID


// ==========================================================================
// Extra information and tokens for calculted variables
// ==========================================================================
const char *waterPressureUUID = "5d20abdd-719b-4116-bc55-0e90550e68a5";
...
const char *waterDepthUUID = "9bb5f30d-9959-40c4-8036-56eb60de740a";
const char *waterDepthVarName = "waterDepth";
const char *waterDepthVarUnit = "millimeter";
const char *waterDepthVarCode = "CalcDepth";
const char *rhoDepthUUID = "1d310068-c52d-4c0d-ad87-e191122eeafa";
